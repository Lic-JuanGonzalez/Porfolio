(function () {
  var T = {
    es: {
      ...
      'project.paymentchain.desc': 'Proyecto final del curso de Microservicios: gestión de transacciones bancarias con Spring Cloud. API Gateway con autenticación OAuth2/Keycloak, service discovery (Eureka), configuración centralizada y monitoreo, orquestando microservicios de clientes, productos y transacciones.',
      ...
      'project.digitrecognizer.desc': 'Reconocimiento de dígitos manuscritos en tiempo real: dibujás en un canvas HTML5 y una CNN entrenada con MNIST clasifica el trazo. Preprocesamiento replica el pipeline de MNIST (recorte al bounding box, reescalado y centrado en 28x28) antes de pasar por el modelo.',
      'project.view':              'Ver proyecto →',
      'skills.title':              'Tecnologías',
      'skills.microservices':      'Microservicios',
      'skills.databases':          'Bases de Datos',
      'skills.tools':              'Tools & Proceso',
      'articles.label':            'Escritura',
      'articles.title':            'Artículos',
      'articles.subtitle':         'Ensayos sobre programación asistida por IA, todavía sin publicar en LinkedIn.',
      'articles.soon':             'Próximamente en LinkedIn',
      'article.1.title':           'Programar sin código: el lenguaje natural como el nuevo lenguaje de programación',
      'article.2.title':           'Prompt engineering como nueva sintaxis',
      'article.3.title':           'Ambigüedad como bug',
      'article.1.desc':            'Durante siete décadas programar significó aprender una sintaxis artificial. La hipótesis: la próxima capa de programación es el lenguaje natural mismo, mediado por LLMs.',
      'article.2.desc':            'Si el lenguaje natural es la nueva interfaz de programación, ¿está emergiendo dentro de él una sintaxis propia que separa un prompt efectivo de uno que no lo es?',
      'article.3.desc':            'Un compilador rechaza un programa ambiguo antes de ejecutarlo. El lenguaje natural no: la misma consigna admite lecturas distintas y "compila" igual, sin señalizar la duda.',
    ...
    en: {
      ...
      'project.paymentchain.desc': 'Final project for the Microservices course: banking transaction management built with Spring Cloud. OAuth2/Keycloak-secured API Gateway, service discovery (Eureka), centralized configuration and monitoring, orchestrating customer, product and transaction microservices.',
      ...
      'project.digitrecognizer.desc': 'Real-time handwritten digit recognition: draw on an HTML5 canvas and a CNN trained on MNIST classifies the stroke. Preprocessing mirrors MNIST\'s own pipeline (crop to bounding box, rescale and center in 28x28) before running through the model.',
      'project.view':              'View project →',
      'skills.title':              'Technologies',
      'skills.microservices':      'Microservices',
      'skills.databases':          'Databases',
      'skills.tools':              'Tools & Process',
      'articles.label':            'Writing',
      'articles.title':            'Articles',
      'articles.subtitle':         'Essays on AI-assisted programming, not yet published on LinkedIn.',
      'articles.soon':             'Coming soon on LinkedIn',
      'article.1.title':           'Coding Without Code: Natural Language as the New Programming Language',
      'article.2.title':           'Prompt Engineering as the New Syntax',
      'article.3.title':           'Ambiguity as a Bug',
      'article.1.desc':            'For seven decades, programming meant learning an artificial syntax. The hypothesis: the next layer of programming is natural language itself, mediated by LLMs.',
      'article.2.desc':            'If natural language is the new programming interface, is a syntax of its own emerging within it — one that separates an effective prompt from an ineffective one?',
      'article.3.desc':            'A compiler rejects an ambiguous program before running it. Natural language doesn\'t: the same instruction admits different readings and still "compiles" anyway, without signaling the doubt.',
